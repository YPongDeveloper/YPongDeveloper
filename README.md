...
# Hi 👋, I'm Pongsakorn Yimsuk-anan

### 💻 Fullstack Developer · Freelance · Bangkok

</div>

<br>

<!-- Row 1: GIF (left) + Tech Stack (right) -->
<table width="100%">
<tr>
<td width="45%" align="center" valign="middle">
  <img src="programmer.gif" width="380" alt="Programmer">
</td>
...
<!-- Row 2: Experience (left) + Education + Contact (right) -->
<table width="100%">
<tr>
<td width="55%" valign="top">
...
- E-Commerce Web Application (React + Golang)

**💻 Fullstack Developer · Prior Solution Co., Ltd.** `2024 — 2025`
- Environmental management systems (Backend: Spring Boot)
- Mobile application for restaurant system (Flutter + Golang)
- Token management system for Chatbot AI (Frontend: React)

**🛠️ Intern Fullstack Developer · Prior Solution Co., Ltd.** `2019 — 2020`
- Backend development with Go (Golang) and Spring Boot
...
**Bachelor of Computer Science** | GPAX 3.41 · Second Class Honors

🏛️ Silpakorn University `2021 — 2025`
